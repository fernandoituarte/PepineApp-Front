...
import { deleteCategory } from "@/store/reducer/products/update-categories/productCategories";
    ...
    <div className="mt-8 flex flex-wrap">
      ...
      {categories.includes(5) && (
        ...
        >
          ...
          <button
            type="button"
            onClick={() => dispatch(deleteCategory(5))}
            className="inline-flex items-center p-1 ms-2 text-sm text-green-400 bg-transparent rounded-sm hover:bg-green-200 hover:text-green-900 "
            data-dismiss-target="#badge-dismiss-green"
            aria-label="Remove"
          >
      ...
      {categories.includes(6) && (
        ...
        >
          ...
          <button
            type="button"
            onClick={() => dispatch(deleteCategory(6))}
            className="inline-flex items-center p-1 ms-2 text-sm text-green-400 bg-transparent rounded-sm hover:bg-green-200 hover:text-green-900 "
            data-dismiss-target="#badge-dismiss-green"
            aria-label="Remove"
          >
